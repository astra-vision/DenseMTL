...
class BackprojectDepth(nn.Module):
    ...
    def __init__(self, batch_size, height, width):
        ...
        self.id_coords = nn.Parameter(torch.from_numpy(self.id_coords), #? nn.Parameter not needed if requires_grad = False, right?
                                      requires_grad=False)
    ...
    def forward(self, depth, inv_K):
        cam_points = inv_K[:, :3, :3] @ self.pix_coords
        cam_points = depth.flatten(2) * cam_points
